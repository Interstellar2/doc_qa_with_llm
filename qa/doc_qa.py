...
from model.llm_chat_api import chat_completion
from utils.logger import logger
from config.config_parser import MILVUS_SIZE, ES_SIZE, MILVUS_THRESHOLD, EMBEDDING_MODEL
...
class DocQA(object):
    ...
    def get_qa_prompt(self):
        ...
        contexts = []
        sources = []
        for i, text_source_tuple in enumerate(self.get_context()):
